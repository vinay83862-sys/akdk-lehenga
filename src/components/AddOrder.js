// AddOrder.js - Next Level UI with Enhanced Sidebar
import React, { useState, useEffect } from 'react';
import { ref, push, onValue, set } from 'firebase/database';
import { db } from '../firebase';
import './AddOrder.css';

function AddOrder({ onNavigate, currentUser }) {
  ...
  // Load customers, stock items, and salesmen from Firebase
  useEffect(() => {
    setLoading(true);
  ...
  // Fixed Salesmen Selection with proper checkbox handling
  const handleSalesmanToggle = (lehengaIndex, salesmanName) => {
    ...
    // Clear salesmen error when at least one is selected
  ...
  const handleSubmit = (e) => {
    ...
    // Format dates for storage (DD-MM-YYYY)
    ...
    const orderData = {
      ...
      weekBeforeNotificationSent: false,
      twoDaysBeforeNotificationSent: false,
      deliveryDayNotificationSent: false
    };
      ...
      <div className="form-content">
        <div className="content-header">
          <div className="header-main">
            ...
            <p>Fill in the details below to add a new order to the system</p>
          </div>
                ...
                <div className="salesmen-section">
                  ...
                  {loading ? (
                    ...
                    <div className="no-salesmen">
                      No salesmen available. Please add salesmen first.
                    </div>
                  )}
